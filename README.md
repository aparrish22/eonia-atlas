...
Internal documentation for Eonia Atlas:

- [Documentation index](docs/index.md) — quick table of contents
- [Architecture](docs/architecture.md) — app structure, APIs, and data layout
- [Content (MDX + lore)](docs/content.md) — authoring entries and the lore pipeline
- [Maps](docs/maps.md) — gallery, viewer, pins, and related APIs
